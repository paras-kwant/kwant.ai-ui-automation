...
describe(
  ...
  () => {
    ...
    it(
      ...
      () => {
        ...
        expectedTexts.forEach((text) => {
          cy.get('.hover-hoc-container__label').contains(text).should('exist');
        });
    ...
    it(
      "should display the correct tooltip information on clicking the info icon in Personal Details",
      { tags: ["Story:Personal Details Tooltip Info Icon", "Severity:normal", "UI", "Module:Workforce-Worker"] },
      () => {
    ...
    it(
      "should show toast message for invalid phone number input",
      { tags: ["Story:Personal Details Invalid Phone Number Validation", "Severity:critical", "UI", "Module:Workforce-Worker"] },
      () => {
        cy.get(workforceSelector.tableRow).eq(0).click({ force: true });
        cy.get(workforceSelector.personalDetailsPage).click();
    ...
    it(
      "should show toast message for invalid email input",
      { tags: ["Story:Personal Details Invalid Email Validation", "Severity:critical", "UI", "Module:Workforce-Worker"] },
      () => {
        cy.get(workforceSelector.tableRow).eq(0).click({ force: true });
        cy.get(workforceSelector.personalDetailsPage).click();
