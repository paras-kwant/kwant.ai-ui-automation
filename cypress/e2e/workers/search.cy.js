...
describe(
  ...
  { tags: ["Epic:WorkForce", "Feature:Search", "Module:Workforce-Worker"] },
  () => {
    ...
    it(
      "Validating search functionality with empty input keeps rows unchanged",
      { tags: ["Story:Search Empty Input", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
        cy.wait(3000);
    ...
    it(
      "Validating search functionality with job title in use",
      { tags: ["Story:Search By Job Title", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
    ...
    it(
      "Validating search functionality with company in use",
      { tags: ["Story:Search By Company", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
        cy.get(workforceSelector.tableRow)
          .eq(0)
          .find(".cell-content")
    ...
    it(
      "Validating search functionality with device in use",
      { tags: ["Story:Search By Device", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
        cy.get(workforceSelector.tableRow)
          .eq(0)
          .find(".cell-content")
    ...
    it(
      ...
      { tags: ["Story:Search By Last Seen Location", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
        cy.get(workforceSelector.tableRow)
          .eq(1)
          .find(".loc-content")
    ...
    it(
      "Turning on all the columns and testing",
      { tags: ["Story:Toggle All Columns", "Severity:normal", "Module:Workforce-Worker"] },
      () => {
