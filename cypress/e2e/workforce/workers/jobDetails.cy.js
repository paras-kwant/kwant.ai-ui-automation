  ...
  () => {
    ...
    it(
      ...
      () => {
        ...
        cy.get('.hover-hoc-container__label').eq(1).find('svg').realHover();
   ...
   cy.get('.hover-hoc-container__input__display-value').eq(2)
          .realHover()
          .find('.edit-icon > svg')
          .should('be.visible')
          .click({ force: true });
    ...
    it(
      "should display correct tooltip information when clicking the Worker Role info icon",
      { tags: ["Story:Job Details Worker Role Tooltip Info", "Severity:normal", "UI", "Module:Workforce-Worker"] },
      () => {
